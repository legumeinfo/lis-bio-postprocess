...
/**
 * Create Protein.genes and Gene.proteins collections by using the standard that protein.primaryIdentifier = gene.primaryIdentifier.N.
 *
 * @author Sam Hokin
 */
public class CreateGeneProteinCollectionsProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateGeneProteinCollectionsProcess.class);

    /**
     * Create a new instance of CreateProteinGeneReferencesProcess
     * @param osw object store writer
-     */
    public CreateGeneProteinCollectionsProcess(ObjectStoreWriter osw) {
        super(osw);
    }
