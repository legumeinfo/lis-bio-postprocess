 ...
 * @author Sam Hokin
 */
public class PopulateTranscriptProteinProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateTranscriptProteinProcess.class);

    /**
     * Populate a new instance of PopulateTranscriptProteinProcess
     * @param osw object store writer
-     */
    public PopulateTranscriptProteinProcess(ObjectStoreWriter osw) {
        super(osw);
    }
