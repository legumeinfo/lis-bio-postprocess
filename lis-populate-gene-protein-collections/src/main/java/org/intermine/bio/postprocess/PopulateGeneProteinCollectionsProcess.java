 ...
 * @author Sam Hokin
 */
public class PopulateGeneProteinCollectionsProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateGeneProteinCollectionsProcess.class);

    /**
     * Populate a new instance of PopulateProteinGeneReferencesProcess
     * @param osw object store writer
-     */
    public PopulateGeneProteinCollectionsProcess(ObjectStoreWriter osw) {
        super(osw);
    }
