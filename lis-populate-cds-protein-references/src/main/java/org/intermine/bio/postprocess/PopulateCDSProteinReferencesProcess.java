 ...
 * @author Sam Hokin
 */
public class PopulateCDSProteinReferencesProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateCDSProteinReferencesProcess.class);

    /**
     * Populate a new instance of PopulateCDSProteinReferencesProcess
     * @param osw object store writer
-     */
    public PopulateCDSProteinReferencesProcess(ObjectStoreWriter osw) {
        super(osw);
    }
