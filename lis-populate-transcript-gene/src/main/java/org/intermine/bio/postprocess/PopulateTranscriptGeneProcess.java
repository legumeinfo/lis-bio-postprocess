 ...
 * @author Sam Hokin
 */
public class PopulateTranscriptGeneProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateTranscriptGeneProcess.class);

    /**
     * Populate a new instance of PopulateTranscriptGeneProcess
     * @param osw object store writer
-     */
    public PopulateTranscriptGeneProcess(ObjectStoreWriter osw) {
        super(osw);
    }
