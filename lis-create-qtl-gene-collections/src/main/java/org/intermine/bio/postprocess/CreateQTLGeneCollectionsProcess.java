 ...
 * @author Sam Hokin
 */
public class CreateQTLGeneCollectionsProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateQTLGeneCollectionsProcess.class);

    /**
     * Construct with an ObjectStoreWriter, read and write from the same ObjectStore
     * @param osw object store writer
     */
    public CreateQTLGeneCollectionsProcess(ObjectStoreWriter osw) {
        super(osw);
    }
