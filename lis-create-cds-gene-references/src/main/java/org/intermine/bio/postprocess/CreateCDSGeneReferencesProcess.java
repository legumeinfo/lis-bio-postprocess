 ...
 * @author Sam Hokin
 */
public class CreateCDSGeneReferencesProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateCDSGeneReferencesProcess.class);

    /**
     * Create a new instance of CreateCDSGeneReferencesProcess
     * @param osw object store writer
-     */
    public CreateCDSGeneReferencesProcess(ObjectStoreWriter osw) {
        super(osw);
    }
