 ...
 * @author Sam Hokin
 */
public class PopulateCDSProteinProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateCDSProteinProcess.class);

    /**
     * Populate a new instance of PopulateCDSProteinProcess
     * @param osw object store writer
-     */
    public PopulateCDSProteinProcess(ObjectStoreWriter osw) {
        super(osw);
    }
