 ...
 * @author Sam Hokin
 */
public class CreateTranscriptGeneReferencesProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateTranscriptGeneReferencesProcess.class);

    /**
     * Create a new instance of CreateTranscriptGeneReferencesProcess
     * @param osw object store writer
-     */
    public CreateTranscriptGeneReferencesProcess(ObjectStoreWriter osw) {
        super(osw);
    }
