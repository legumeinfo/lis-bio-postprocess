 ...
 * @author Sam Hokin
 */
public class PopulateCDSTranscriptProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateCDSTranscriptProcess.class);

    /**
     * Populate a new instance of PopulateCDSTranscriptProcess
     * @param osw object store writer
-     */
    public PopulateCDSTranscriptProcess(ObjectStoreWriter osw) {
        super(osw);
    }
