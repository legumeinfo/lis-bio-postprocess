 ...
 * @author Sam Hokin
 */
public class CreateCDSTranscriptReferencesProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateCDSTranscriptReferencesProcess.class);

    /**
     * Create a new instance of CreateCDSTranscriptReferencesProcess
     * @param osw object store writer
-     */
    public CreateCDSTranscriptReferencesProcess(ObjectStoreWriter osw) {
        super(osw);
    }
