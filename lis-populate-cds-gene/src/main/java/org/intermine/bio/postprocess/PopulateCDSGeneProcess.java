 ...
 * @author Sam Hokin
 */
public class PopulateCDSGeneProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateCDSGeneProcess.class);

    /**
     * Populate a new instance of PopulateCDSGeneProcess
     * @param osw object store writer
-     */
    public PopulateCDSGeneProcess(ObjectStoreWriter osw) {
        super(osw);
    }
