 ...
 * @author Sam Hokin
 */
public class PopulateProteinPathwaysProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(PopulateProteinPathwaysProcess.class);
    private Model model;
     ...
     */
    public PopulateProteinPathwaysProcess(ObjectStoreWriter osw) {
        super(osw);
