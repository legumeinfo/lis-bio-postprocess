 ...
 * @author Sam Hokin
 */
public class CreateTranscriptProteinReferencesProcess extends PostProcessor {

    private static final Logger LOG = Logger.getLogger(CreateTranscriptProteinReferencesProcess.class);

    /**
     * Create a new instance of CreateTranscriptProteinReferencesProcess
     * @param osw object store writer
-     */
    public CreateTranscriptProteinReferencesProcess(ObjectStoreWriter osw) {
        super(osw);
    }
